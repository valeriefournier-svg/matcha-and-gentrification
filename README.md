...
Then to support this hypothesis, I looked at more significant data, such as rents asked, average incomes and ethnicity distribution. I took me hours to finally get an easy to handle and to understand data set, thanks to the NYU Furman Center for Real Estate and Urban Policy. I only had to clean the files to keep the rows about Central Harlem. I worked with datawrapper and flourish to display the results. Pictures are mine, except the header from a free images database.

Knowing that two months ago, I had never use my computer for nothing but Google search and typing texts, I am quite proud of the story I managed to achieve.
